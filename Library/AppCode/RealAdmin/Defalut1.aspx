<%@ Page Title="" Language="C#" MasterPageFile="~/AppCode/RealAdmin/NewAdminMaster.Master" AutoEventWireup="true" CodeBehind="Defalut1.aspx.cs" Inherits="Library.AppCode.RealAdmin.Defalut1" %>
    ...
    <div class="container mt-5">
        ...
        <div class="row mb-4">
            <div class="col">
                ...
                <asp:Button ID="btnSearch" runat="server" Text="חיפוש" CssClass="btn btn-primary mt-2" OnClick="btnSearch_Click" />
        ...
        <div class="row mb-4">
            <div class="col">
                ...
                <div class="card-deck">
                    <asp:Repeater ID="rptPopularUsers" runat="server">
                        <ItemTemplate>
                            <div class="card">
